...
The parameter *NumberOfSensors* (which is optional) is the number of sensors the driver should report data from. This value can also be available as a VSCP daemon variable and if both are present the VSCP daemon variable will be used. 
 ...
 | _vscptype[0..n]   | integer | VSCP Type to use for events. Currently the type must be one from [CLASS1.MEASUREMENT](https://grodansparadis.gitbooks.io/the-vscp-specification/class1.measurement.html) | 
 | _vscpclass[0..n]  | integer | VSCP class to use. Currently [CLASS1.MEASUREMENT](https://grodansparadis.gitbooks.io/the-vscp-specification/class1.measurement.html), [CLASS1.MEASUREMENT64](https://grodansparadis.gitbooks.io/the-vscp-specification/class1.measurement64.html), [CLASS1.MEASUREZONE](https://grodansparadis.gitbooks.io/the-vscp-specification/class1.measurezone.html), [CLASS1.SETVALUEZONE](https://grodansparadis.gitbooks.io/the-vscp-specification/class1.setvaluezone.html), [CLASS2.MEASUREMENT_STR](https://grodansparadis.gitbooks.io/the-vscp-specification/class2.measurement_str.html) is allowed. | 
 | _vscpindex        | integer | Needed index parameter if [CLASS2.MEASUREMENT_STR](https://grodansparadis.gitbooks.io/the-vscp-specification/class2.measurement_str.html), [CLASS1.MEASUREZONE](https://grodansparadis.gitbooks.io/the-vscp-specification/class1.measurezone.html) or [CLASS1.SETVALUEZONE](https://grodansparadis.gitbooks.io/the-vscp-specification/class1.setvaluezone.html) class is used                                                                                                                                                                                    | 
 ...
 | _coding[0..n]     | integer | VSCP measurement coding to use for events. Not used if class is Index use if class is [CLASS2.MEASUREMENT_STR](https://grodansparadis.gitbooks.io/the-vscp-specification/class2.measurement_str.html)                                                                                                                                                                                                                                                                                                                          | 
...
Example for variable configuration. In this sample the core temperature for two CPU's is reported as [CLASS1.MEASUREMENT, Type=6 temperature](https://grodansparadis.gitbooks.io/the-vscp-specification/class1.measurement.html#type6).
